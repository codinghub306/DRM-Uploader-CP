...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", "6443740402"))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "6443740402").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client(
    "bot",
    api_id="20928172",
    api_hash="48ed56c8db54f85d232f576b150360ef",
    bot_token="7861248858:AAE2l3QNShvhXG4r53WQHStV3ZdqCgWX8kc"
)
